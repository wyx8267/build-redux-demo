...
const NoteEditor = ({ note, onChangeNote, onCloseNote }) => (
  <div>
    <div>
      <textarea className="editor-content" autoFocus cols="80" rows="10" value={note.content} onChange={event => onChangeNote(note.id, event.target.value)}></textarea>
    </div>
  ...
  <div>
    {
      openNoteId ?
        <NoteEditor
          note={notes[openNoteId]} onChangeNote={onChangeNote} onCloseNote={onCloseNote} />
        :
        <div>
...
// export default class NoteAppContainer extends React.Component {
//   constructor(props) {
//     super()
